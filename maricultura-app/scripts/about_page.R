...
project <- HTML('<div style="height: 75vh; overflow: auto" class="jumbotron">
  ...
  <p style="text-align: justify;" class="lead">The Bren School at UC Santa Barbara is a graduate-level environmental science and management program, in which students fulfill a 12-month Group Project to solve an environmental challenge faced by a real-world client, in our case, the World Wildlife Fund. We explored the spatial feasibility of offshore mariculture in Brazil’s Exclusive Economic Zone, and created a web-based tool to predict potential yields and profitability for offshore mariculture of various finfish. This app is the interactive component of our overall thesis project.</p>
