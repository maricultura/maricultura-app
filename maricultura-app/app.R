...
ui <- fluidPage(
  ...
  navbarPage("" ,
             ...
             tabPanel(div(icon("info-circle"),"About"),
                      HTML('<div class="jumbotron" style="height: 75vh; display: flex; justify-content: center; align-items: center; background: linear-gradient( rgba(197,219,235, 0.65), rgba(197,219,235, 0.8)),
	url(https://images.unsplash.com/photo-1518837695005-2083093ee35b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80); background-size: cover; background-position: center top; letter-spacing: 0.7em;">
                      ...
                      HTML('<div style="height: 75vh; display: table;" class="jumbotron">
                      <div style="display: table-cell; vertical-align: middle;">
  <h1 class="display-3" >The Project</h1>
  <p class="lead">The <a href=https://www.bren.ucsb.edu target="_blank">Bren School</a> at UC Santa Barbara is a graduate-level environmental science and management program whose students fulfill a 12 month Group Project to solve an environmental problem faced by a real-world client, in our case, the World Wildlife Fund. We explored the spatial feasibility of offshore mariculture in Brazil’s Exclusive Economic Zone, and created a web-based tool to predict yields and profitability for offshore mariculture of various finfish. This app is the interactive component of our overall thesis project.</p>
  </div>
</div>'
                      ),
                      HTML('<div style="height: 75vh; overflow: auto;  display: table;" class="jumbotron">
                        <div style="display: table-cell; vertical-align: middle;">
  <h1 class="display-3"> Meet the Creators</h1>
  <img style="width: 30%; left-padding: 20px; bottom-padding: 20px; display: block; float:right; vertical-align: middle" src="maricultura-team.jpg" alt="Team image">
  <p class="lead">Our team consists of 5 master’s students at the Bren School of Environmental Science & Management at the University of California, Santa Barbara: Anna Calle, Caio Vianna, Eva Marrero, Kirby Barttlet and Sandra Fogg. We came together as a group with a common interest in marine conservation and ocean sustainability. Our collaborative thesis is in partnership with the World Wildlife Fund in Brazil.</p>
  <p class="lead">For more information visit our website.</p>
  <p class="lead">
    <a style="vertical-align: bottom;" class="btn btn-primary btn-lg" href=""https://maricultura.weebly.com"" role="button">Learn more</a>
  </p>
  </div>
</div>')),
