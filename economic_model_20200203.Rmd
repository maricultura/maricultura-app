...
trips_annual <- 416 # roundtrips per farm per year (1 boat @ 5 trips/week, 1 @ 8 trips per week, and 52 weeks a year)


# Create raster for all fuel costs:
annual_fuel_cost_econ <- (dist_shore_econ/vessel_speed)*fuel_consumption*diesel_price*trips_annual*num_of_boats
...
##### 2/2 Later Attempt: Labor Costs in A Year
oneyear_labor_costs <- fixed_labor + ((dist_shore_econ*workers_offshore *hourly_wage*(trips_annual*2))/vessel_speed)
plot(oneyear_labor_costs)
