...
# Non-Amoratized One-time Costs
one_time_fixed_costs_notdepreciated <- (farm_lease + project_development)

# Amortized One-time Costs
one_time_fixed_costs_depreciated <- (signaling_system + miscellaneous + boats + total_cage_cost + farm_installation) #### ONLY PART TO AMORTIZE - find out how to apply annuity
...
a <- annuity(one_time_fixed_costs_depreciated)
a(one_time_fixed_costs_depreciated)
total_annuity <- a(one_time_fixed_costs_depreciated)
total_annuity
