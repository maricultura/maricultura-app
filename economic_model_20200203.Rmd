...
trips_annual <- 416 #Roundtrips trips 8 trips per week and 52 weeks a year
...
annual_fuel_cost_econ <- (dist_shore_econ/vessel_speed)*fuel_consumption*diesel_price*trips_free_annual*num_of_boats
